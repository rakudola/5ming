...
output_file = "../CD input/fun time/test file combine.csv"

"""
Changing code below here will affect functionality
"""
def file_combine(first_file, second_file, output_file):
    """
    first_file = protein-peptides.csv
    second_file = proteins.csv
    """
    # INPUT FIRST FILE
    dataA = []
    ...
    with open(first_file, "r") as first_infile:
        ...
        headerA = ["row#", "Protein Accession", "Description", "real peptide", "#reporter",
