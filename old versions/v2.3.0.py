...
condition = {'conditions' : 2,
    1: {'description' : 'Ad Libitum', 'plot color' : 1, 'replicates' : 4,   # condition 1
...
def plot_color(col, con):
    for x in range(1, condition[con]['replicates']):
        ...
        pylab.plot(x1, y1, colors[col]['data'], label = condition[con]['description'] + ' fit')
        pylab.axvline(condition1_Chalf, color = colors[col]['Chalf'], ls = '-', label = 'C1/2')#chalf
        if CI_ratioTOrange1 < CI_cutoff:
            plt.axvspan((condition1_Chalf-condition[1]['fit output'][8]),
                        (condition1_Chalf+condition[1]['fit output'][8]),
...
if numOfCondition=="2":
    ...
    for x in range(1, condition['conditions'] + 1):
        for y in range(1, condition[x]['replicates'] + 1):
            read_xdata(condition[x][y]['xdata'], condition[x][y]['Start'], condition[x][y]['End'])
            
    """#condition 1 info
    read_xdata(condition[1][1]['xdata'], condition[1][1]['Start'], condition[1][1]['End'])
    read_xdata(condition[1][2]['xdata'], condition[1][2]['Start'], condition[1][2]['End'])
    read_xdata(condition[1][3]['xdata'], condition[1][3]['Start'], condition[1][3]['End'])
    read_xdata(condition[1][4]['xdata'], condition[1][4]['Start'], condition[1][4]['End'])

    #condition 2 info
    read_xdata(condition[2][1]['xdata'], condi2_rep1_Start, condi2_rep1_End)
    read_xdata(condition[2][2]['xdata'], condi2_rep2_Start, condi2_rep2_End)
    read_xdata(condition[2][3]['xdata'], condi2_rep3_Start, condi2_rep3_End)
    read_xdata(condition[2][4]['xdata'], condi2_rep4_Start, condi2_rep4_End)"""
    ...
    for row in reader:
        try:      
            ...
            read_ydata(condition[1][2]['ydata'], condition[1][2]['Start'], condition[1][2]['End'])
            read_ydata(condition[1][3]['ydata'], condition[1][3]['Start'], condition[1][3]['End'])
            read_ydata(condition[1][4]['ydata'], condition[1][4]['Start'], condition[1][4]['End'])
            ...
            read_ydata(condition[2][1]['ydata'], condi2_rep1_Start, condi2_rep1_End)
            read_ydata(condition[2][2]['ydata'], condi2_rep2_Start, condi2_rep2_End)
            read_ydata(condition[2][3]['ydata'], condi2_rep3_Start, condi2_rep3_End)
            read_ydata(condition[2][4]['ydata'], condi2_rep4_Start, condi2_rep4_End)
        except:
            pass
        ...
        try: # if statment, when it is not error   
            ...
            condition[1][2]['normalized_ydata'] = []
            condition[1][2]['normalized_xdata'] = []
            condition[1][3]['normalized_ydata'] = []
            condition[1][3]['normalized_xdata'] = []
            condition[1][4]['normalized_ydata'] = []
            condition[1][4]['normalized_xdata'] = []
            
            condition[2][1]['normalized_ydata'] = []
            condition[2][1]['normalized_xdata'] = []
            condition[2][2]['normalized_ydata'] = []
            condition[2][2]['normalized_xdata'] = []
            condition[2][3]['normalized_ydata'] = []
            condition[2][3]['normalized_xdata'] = []
            condition[2][4]['normalized_ydata'] = []
            condition[2][4]['normalized_xdata'] = []
            ...
            normalize_data(condition[1][2]['xdata'], condition[1][2]['ydata'], condition[1][2]['normalized_xdata'], condition[1][2]['normalized_ydata'], tempRow)
            normalize_data(condition[1][3]['xdata'], condition[1][3]['ydata'], condition[1][3]['normalized_xdata'], condition[1][3]['normalized_ydata'], tempRow)
            normalize_data(condition[1][4]['xdata'], condition[1][4]['ydata'], condition[1][4]['normalized_xdata'], condition[1][4]['normalized_ydata'], tempRow)
            
            #normalizing condition2 dataset
            normalize_data(condition[2][1]['xdata'], condition[2][1]['ydata'], condition[2][1]['normalized_xdata'], condition[2][1]['normalized_ydata'], tempRow)
            normalize_data(condition[2][2]['xdata'], condition[2][2]['ydata'], condition[2][2]['normalized_xdata'], condition[2][2]['normalized_ydata'], tempRow)
            normalize_data(condition[2][3]['xdata'], condition[2][3]['ydata'], condition[2][3]['normalized_xdata'], condition[2][3]['normalized_ydata'], tempRow)
            normalize_data(condition[2][4]['xdata'], condition[2][4]['ydata'], condition[2][4]['normalized_xdata'], condition[2][4]['normalized_ydata'], tempRow)
            ...
            plot_data(condition[1][2]['xplot'], condition[1][2]['yplot'], condition[1][2]['normalized_xdata'], condition[1][2]['normalized_ydata'])
            plot_data(condition[1][3]['xplot'], condition[1][3]['yplot'], condition[1][3]['normalized_xdata'], condition[1][3]['normalized_ydata'])
            plot_data(condition[1][4]['xplot'], condition[1][4]['yplot'], condition[1][4]['normalized_xdata'], condition[1][4]['normalized_ydata'])
                    
            #condition2
            for i in range (len(condition[2][1]['normalized_ydata'])):   
                if condition[2][1]['normalized_ydata'][i]!="error":
                    condition[2][1]['yplot'].append(condition[2][1]['normalized_ydata'][i])
                    condition[2][1]['xplot'].append(condition[2][1]['normalized_xdata'][i])                    
            
            for i in range (len(condition[2][2]['normalized_ydata'])):   
                if condition[2][2]['normalized_ydata'][i]!="error":
                    condition[2][2]['yplot'].append(condition[2][2]['normalized_ydata'][i])
                    condition[2][2]['xplot'].append(condition[2][2]['normalized_xdata'][i]) 

            for i in range (len(condition[2][3]['normalized_ydata'])):   
                if condition[2][3]['normalized_ydata'][i]!="error":
                    condition[2][3]['yplot'].append(condition[2][3]['normalized_ydata'][i])
                    condition[2][3]['xplot'].append(condition[2][3]['normalized_xdata'][i]) 
            
            for i in range (len(condition[2][4]['normalized_ydata'])):   
                if condition[2][4]['normalized_ydata'][i]!="error":
                    condition[2][4]['yplot'].append(condition[2][4]['normalized_ydata'][i])
                    condition[2][4]['xplot'].append(condition[2][4]['normalized_xdata'][i]) 
            ...
            y1 = sigmoid(x1, *condition[1]['popt'])# *popt split the two variable 
            condition1_Chalf = condition[1]['fit output'][2]
            condition1_b = condition[1]['fit output'][3]
            ...
            if denatureMethod=="CD":
                ...
                condition[1]['fit output'].append(CI_ratioTOrange1)#[9]
            condition1_CI_Chalf_lowbound = condition1_Chalf - condition[1]['fit output'][8]
            condition1_CI_Chalf_upbound = condition1_Chalf + condition[1]['fit output'][8]
            ...
            condition1_CI_b_lowbound=condition1_b-condition[1]['fit output'][12]
            condition1_CI_b_upbound=condition1_b+condition[1]['fit output'][12]
            ...
            if condition[1]['plot color'] == 1: # choose from blue, orange, purple, brown
                ...
                plt.plot(condition[1][3]['xplot'], condition[1][3]['yplot'],color=colors[1]['data'],ls=':',marker='s',label=condi1_rep3_notebookcode)
                plt.plot(condition[1][4]['xplot'], condition[1][4]['yplot'],color=colors[1]['data'],ls=':',marker='*',label=condi1_rep4_notebookcode)
                pylab.plot(x1,y1,colors[1]['data'], label=condition[1]['description']+' fit')
                pylab.axvline(condition1_Chalf,color=colors[1]['Chalf'],ls='-',label='C1/2')#chalf
                if CI_ratioTOrange1<CI_cutoff:
                    plt.axvspan((condition1_Chalf-condition[1]['fit output'][8]), (condition1_Chalf+condition[1]['fit output'][8]),color=colors[1]['CI'])#CI
                ...
                plt.plot(condition[1][3]['xplot'], condition[1][3]['yplot'],color=colors[2]['data'],ls=':',marker='s',label=condi1_rep3_notebookcode)
                plt.plot(condition[1][4]['xplot'], condition[1][4]['yplot'],color=colors[2]['data'],ls=':',marker='*',label=condi1_rep4_notebookcode)
                pylab.plot(x1,y1,colors[2]['data'], label=condition[1]['description']+' fit')
                pylab.axvline(condition1_Chalf,color=colors[2]['Chalf'],ls='-',label='C1/2')#chalf
                if CI_ratioTOrange1<CI_cutoff:
                    plt.axvspan((condition1_Chalf-condition[1]['fit output'][8]), (condition1_Chalf+condition[1]['fit output'][8]),color=colors[2]['CI'])#CI
                ...
                plt.plot(condition[1][3]['xplot'], condition[1][3]['yplot'],color=colors[3]['data'],ls=':',marker='s',label=condi1_rep3_notebookcode)
                plt.plot(condition[1][4]['xplot'], condition[1][4]['yplot'],color=colors[3]['data'],ls=':',marker='*',label=condi1_rep4_notebookcode)
                pylab.plot(x1,y1,colors[3]['data'], label=condition[1]['description']+' fit')
                pylab.axvline(condition1_Chalf,color=colors[3]['Chalf'],ls='-',label='C1/2')#chalf
                if CI_ratioTOrange1<CI_cutoff:
                    plt.axvspan((condition1_Chalf-condition[1]['fit output'][8]), (condition1_Chalf+condition[1]['fit output'][8]),color=colors[3]['CI'])#CI
                ...
                plt.plot(condition[1][3]['xplot'], condition[1][3]['yplot'],color=colors[4]['data'],ls=':',marker='s',label=condi1_rep3_notebookcode)
                plt.plot(condition[1][4]['xplot'], condition[1][4]['yplot'],color=colors[4]['data'],ls=':',marker='*',label=condi1_rep4_notebookcode)
                pylab.plot(x1,y1,colors[4]['data'], label=condition[1]['description']+' fit')
                pylab.axvline(condition1_Chalf,color=colors[4]['Chalf'],ls='-',label='C1/2')#chalf
                if CI_ratioTOrange1<CI_cutoff:
                    plt.axvspan((condition1_Chalf-condition[1]['fit output'][8]), (condition1_Chalf+condition[1]['fit output'][8]),color=colors[4]['CI'])#CI

            #condition2_plot color
            if condition2_plotColor=="1":#choose from blue, orange, purple, brown
                plt.plot(condition[2][1]['xplot'], condition[2][1]['yplot'],color=colors[1]['data'],ls=':',marker='o',label=condi2_rep1_notebookcode)
                plt.plot(condition[2][2]['xplot'], condition[2][2]['yplot'],color=colors[1]['data'],ls=':',marker='^',label=condi2_rep2_notebookcode)
                plt.plot(condition[2][3]['xplot'], condition[2][3]['yplot'],color=colors[1]['data'],ls=':',marker='s',label=condi2_rep3_notebookcode)
                plt.plot(condition[2][4]['xplot'], condition[2][4]['yplot'],color=colors[1]['data'],ls=':',marker='*',label=condi2_rep4_notebookcode)
                pylab.plot(x2,y2,colors[1]['data'], label=condition2_description+' fit')
                ...
                plt.plot(condition[2][1]['xplot'], condition[2][1]['yplot'],color=colors[2]['data'],ls=':',marker='o',label=condi2_rep1_notebookcode)
                plt.plot(condition[2][2]['xplot'], condition[2][2]['yplot'],color=colors[2]['data'],ls=':',marker='^',label=condi2_rep2_notebookcode)
                plt.plot(condition[2][3]['xplot'], condition[2][3]['yplot'],color=colors[2]['data'],ls=':',marker='s',label=condi2_rep3_notebookcode)
                plt.plot(condition[2][4]['xplot'], condition[2][4]['yplot'],color=colors[2]['data'],ls=':',marker='*',label=condi2_rep4_notebookcode)
                pylab.plot(x2,y2,colors[2]['data'], label=condition2_description+' fit')
                ...
                plt.plot(condition[2][1]['xplot'], condition[2][1]['yplot'],color=colors[3]['data'],ls=':',marker='o',label=condi2_rep1_notebookcode)
                plt.plot(condition[2][2]['xplot'], condition[2][2]['yplot'],color=colors[3]['data'],ls=':',marker='^',label=condi2_rep2_notebookcode)
                plt.plot(condition[2][3]['xplot'], condition[2][3]['yplot'],color=colors[3]['data'],ls=':',marker='s',label=condi2_rep3_notebookcode)
                plt.plot(condition[2][4]['xplot'], condition[2][4]['yplot'],color=colors[3]['data'],ls=':',marker='*',label=condi2_rep4_notebookcode)
                pylab.plot(x2,y2,colors[3]['data'], label=condition2_description+' fit')
                ...
                plt.plot(condition[2][1]['xplot'], condition[2][1]['yplot'],color=colors[4]['data'],ls=':',marker='o',label=condi2_rep1_notebookcode)
                plt.plot(condition[2][2]['xplot'], condition[2][2]['yplot'],color=colors[4]['data'],ls=':',marker='^',label=condi2_rep2_notebookcode)
                plt.plot(condition[2][3]['xplot'], condition[2][3]['yplot'],color=colors[4]['data'],ls=':',marker='s',label=condi2_rep3_notebookcode)
                plt.plot(condition[2][4]['xplot'], condition[2][4]['yplot'],color=colors[4]['data'],ls=':',marker='*',label=condi2_rep4_notebookcode)
                pylab.plot(x2,y2,colors[4]['data'], label=condition2_description+' fit')
