...
def normalize_data(xdata, ydata, normalized_xdata, normalized_ydata):
    """Normalizes data"""
...
if numOfCondition=="2":
    ...
    for row in reader:
        try:      
            ...
            for x in range(1, condition['conditions'] + 1):
                for y in range(1, condition[x]['replicates'] + 1):
                    read_ydata(condition[x][y]['ydata'], condition[x][y]['Start'], condition[x][y]['End'])
        except:
            pass
        ...
        try: # if statment, when it is not error   
            ...
            for x in range(1, condition['conditions'] + 1):
                for y in range(1, condition[x]['replicates'] + 1):
                    normalize_data(condition[x][y]['xdata'], condition[x][y]['ydata'], condition[x][y]['normalized_xdata'], condition[x][y]['normalized_ydata'])
            ...
            for x in range(1, condition['conditions'] + 1):
                for y in range(1, condition[x]['replicates'] + 1):
                    plot_data(condition[x][y]['xplot'], condition[x][y]['yplot'], condition[x][y]['normalized_xdata'], condition[x][y]['normalized_ydata'])
