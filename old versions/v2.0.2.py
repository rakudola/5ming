...
"""class Condition:
    def __init__(self, desc, denature):
        self.desc = desc
        self.denature = denature"""
...
if numOfCondition=="2":
    ...
    #condition 1 info
    ReadXData(xdata1_1, condi1_rep1_Start, condi1_rep1_End)
    ...
    for row in reader:
        try:      
            ...
            ReadYData(ydata1_1, condi1_rep1_Start, condi1_rep1_End)
        ...
        try: # if statment, when it is not error   
            ...
            # normalizing condition1 dataset
            NormalizeData(xdata1_1, ydata1_1, normalized_xdata1_1, normalized_ydata1_1, tempRow)
