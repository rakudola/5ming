...
num_replicate = "4" # number of replicate
...
condition = {
    1: {'description' : 'Ad Libitum', 'plot color' : "1",       # condition 1
        1 : {'notebook code' : '1085',                          # condition 1, replicate 1
             ...
             'xdata' : [], 'ydata' : [],}},                     # x and y data lists; populated in read_data functions
...
if numOfCondition=="2":
    ...
    for row in reader:
        ...
        try: # if statment, when it is not error   
            ...
            # normalizing condition1 dataset
            normalize_data(condition[1][1]['xdata'], condition[1][1]['ydata'], normalized_xdata1_1, normalized_ydata1_1, tempRow)
            ...
            # condition1
            plot_data(xplot1_1, yplot1_1, normalized_xdata1_1, normalized_ydata1_1)
            plot_data(xplot1_2, yplot1_2, normalized_xdata1_2, normalized_ydata1_2)
            plot_data(xplot1_3, yplot1_3, normalized_xdata1_3, normalized_ydata1_3)
            plot_data(xplot1_4, yplot1_4, normalized_xdata1_4, normalized_ydata1_4)
            
            # condition2
            plot_data(xplot2_1, yplot2_1, normalized_xdata2_1, normalized_ydata2_1)
            plot_data(xplot2_2, yplot2_2, normalized_xdata2_2, normalized_ydata2_2)
            plot_data(xplot2_3, yplot2_3, normalized_xdata2_3, normalized_ydata2_3)
            plot_data(xplot2_4, yplot2_4, normalized_xdata2_4, normalized_ydata2_4)
