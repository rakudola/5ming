        ...
        try: # if statment, when it is not error   
            ...
            if condition1_plotColor == "1": # choose from blue, orange, purple, brown
                ...
                if CI_ratioTOrange1<CI_cutoff:
                    plt.axvspan((condition1_Chalf-condition[1]['fit output'][8]), (condition1_Chalf+condition[1]['fit output'][8]),color=color1_CI)#CI
                ...
                if CI_ratioTOrange1<CI_cutoff:
                    plt.axvspan((condition1_Chalf-condition[1]['fit output'][8]), (condition1_Chalf+condition[1]['fit output'][8]),color=color2_CI)#CI
                ...
                if CI_ratioTOrange1<CI_cutoff:
                    plt.axvspan((condition1_Chalf-condition[1]['fit output'][8]), (condition1_Chalf+condition[1]['fit output'][8]),color=color3_CI)#CI
                ...
                if CI_ratioTOrange1<CI_cutoff:
                    plt.axvspan((condition1_Chalf-condition[1]['fit output'][8]), (condition1_Chalf+condition[1]['fit output'][8]),color=color4_CI)#CI
