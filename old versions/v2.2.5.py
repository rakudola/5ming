...
condition = {
    ...
    2: {'description' : 'Dietary restriction', 'plot color' : 2, 'replicates' : 4,}}
    ...
    for row in reader:
        ...
        try: # if statment, when it is not error   
            ...
            if condition2_plotColor=="1":#choose from blue, orange, purple, brown
                plt.plot(xplot2_1, yplot2_1,color=colors[1]['data'],ls=':',marker='o',label=condi2_rep1_notebookcode)
                plt.plot(xplot2_2, yplot2_2,color=colors[1]['data'],ls=':',marker='^',label=condi2_rep2_notebookcode)
                plt.plot(xplot2_3, yplot2_3,color=colors[1]['data'],ls=':',marker='s',label=condi2_rep3_notebookcode)
                plt.plot(xplot2_4, yplot2_4,color=colors[1]['data'],ls=':',marker='*',label=condi2_rep4_notebookcode)
                ...
                plt.plot(xplot2_1, yplot2_1,color=colors[2]['data'],ls=':',marker='o',label=condi2_rep1_notebookcode)
                plt.plot(xplot2_2, yplot2_2,color=colors[2]['data'],ls=':',marker='^',label=condi2_rep2_notebookcode)
                plt.plot(xplot2_3, yplot2_3,color=colors[2]['data'],ls=':',marker='s',label=condi2_rep3_notebookcode)
                plt.plot(xplot2_4, yplot2_4,color=colors[2]['data'],ls=':',marker='*',label=condi2_rep4_notebookcode)
                ...
                plt.plot(xplot2_1, yplot2_1,color=colors[3]['data'],ls=':',marker='o',label=condi2_rep1_notebookcode)
                plt.plot(xplot2_2, yplot2_2,color=colors[3]['data'],ls=':',marker='^',label=condi2_rep2_notebookcode)
                plt.plot(xplot2_3, yplot2_3,color=colors[3]['data'],ls=':',marker='s',label=condi2_rep3_notebookcode)
                plt.plot(xplot2_4, yplot2_4,color=colors[3]['data'],ls=':',marker='*',label=condi2_rep4_notebookcode)
                ...
                plt.plot(xplot2_1, yplot2_1,color=colors[4]['data'],ls=':',marker='o',label=condi2_rep1_notebookcode)
                plt.plot(xplot2_2, yplot2_2,color=colors[4]['data'],ls=':',marker='^',label=condi2_rep2_notebookcode)
                plt.plot(xplot2_3, yplot2_3,color=colors[4]['data'],ls=':',marker='s',label=condi2_rep3_notebookcode)
                plt.plot(xplot2_4, yplot2_4,color=colors[4]['data'],ls=':',marker='*',label=condi2_rep4_notebookcode)
