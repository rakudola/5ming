...
if numOfCondition=="2":
    ...
    for row in reader:
        ...
        try: # if statment, when it is not error   
            ...
            condition[1]['popt'], condition[1]['pcov'] = curve_fit(sigmoid, condition[1][1]['xplot'] + xplot1_2 + xplot1_3 + xplot1_4, condition[1][1]['yplot'] + yplot1_2 + yplot1_3 + yplot1_4)
            condition[1]['fit output'].extend(condition[1]['popt'])#extend merge two list to one big list  
                                                #popt has all the parameter (variable) in regression equation (x,B, A, Chalf, b)                                                                                            #row [-, 0, 1, 2,    3] in  condition[1]['fit output']   
            ...
            condition1_Standard_error = np.sqrt(np.diag(condition[1]['pcov']))
            condition[1]['fit output'].extend(condition1_Standard_error)#[4,5,6,7]=[Berror, Aerror, Chalferror, berror]
            condition1_ConfidenceIntervcondition1_chalf = t.ppf(.975, (sumPoints_condition1-1)) * condition[1]['fit output'][6] / np.sqrt(sumPoints_condition1)
            ...
            condition1_ConfidenceIntervcondition1_b=t.ppf(.975, (sumPoints_condition1-1))* condition[1]['fit output'][7]/np.sqrt(sumPoints_condition1)
            ...
            residuals=(condition[1][1]['yplot']+yplot1_2+yplot1_3+yplot1_4)-sigmoid((condition[1][1]['xplot']+xplot1_2+xplot1_3+xplot1_4),*condition[1]['popt'])
            ...
            if condition1_plotColor == "1": # choose from blue, orange, purple, brown
                ...
                plt.plot(xplot1_2, yplot1_2, color = colors[1]['data'], ls = ':', marker = '^', label = condi1_rep2_notebookcode)
                plt.plot(xplot1_3, yplot1_3,color=colors[1]['data'],ls=':',marker='s',label=condi1_rep3_notebookcode)
                plt.plot(xplot1_4, yplot1_4,color=colors[1]['data'],ls=':',marker='*',label=condi1_rep4_notebookcode)
            ...
            elif condition1_plotColor=="2":#choose from blue, orange, purple, brown
                plt.plot(condition[1][1]['xplot'], condition[1][1]['yplot'],color=colors[2]['data'],ls=':',marker='o',label=condition[1][1]['notebook code'])
                plt.plot(xplot1_2, yplot1_2,color=colors[2]['data'],ls=':',marker='^',label=condi1_rep2_notebookcode)
                plt.plot(xplot1_3, yplot1_3,color=colors[2]['data'],ls=':',marker='s',label=condi1_rep3_notebookcode)
                plt.plot(xplot1_4, yplot1_4,color=colors[2]['data'],ls=':',marker='*',label=condi1_rep4_notebookcode)
            ...
            elif condition1_plotColor=="3":#choose from blue, orange, purple, brown
                plt.plot(condition[1][1]['xplot'], condition[1][1]['yplot'],color=colors[3]['data'],ls=':',marker='o',label=condition[1][1]['notebook code'])
                plt.plot(xplot1_2, yplot1_2,color=colors[3]['data'],ls=':',marker='^',label=condi1_rep2_notebookcode)
                plt.plot(xplot1_3, yplot1_3,color=colors[3]['data'],ls=':',marker='s',label=condi1_rep3_notebookcode)
                plt.plot(xplot1_4, yplot1_4,color=colors[3]['data'],ls=':',marker='*',label=condi1_rep4_notebookcode)
            ...
            elif condition1_plotColor=="4":#choose from blue, orange, purple, brown
                plt.plot(condition[1][1]['xplot'], condition[1][1]['yplot'],color=colors[4]['data'],ls=':',marker='o',label=condition[1][1]['notebook code'])
                plt.plot(xplot1_2, yplot1_2,color=colors[4]['data'],ls=':',marker='^',label=condi1_rep2_notebookcode)
                plt.plot(xplot1_3, yplot1_3,color=colors[4]['data'],ls=':',marker='s',label=condi1_rep3_notebookcode)
                plt.plot(xplot1_4, yplot1_4,color=colors[4]['data'],ls=':',marker='*',label=condi1_rep4_notebookcode)
