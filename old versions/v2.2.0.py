...
def ReadXData(xdata, start, end):    # line 195
    #condition 1 info
...
def ReadYData(ydata, start, end):
    for i in range(start, end + 1): # it means row[5] to row[15]
        flow = float(row[i]) # making the input value to number
        ydata.append(flow)
        
def NormalizeData(xdata, ydata, normalized_xdata, normalized_ydata, tempRow):
...
if numOfCondition=="2":
    ...
    #condition 1 info
    ReadXData(condition[1][1]['xdata'], condition[1][1]['Start'], condition[1][1]['End'])
    ReadXData(xdata1_2, condi1_rep2_Start, condi1_rep2_End)
    ReadXData(xdata1_3, condi1_rep3_Start, condi1_rep3_End)
    ReadXData(xdata1_4, condi1_rep4_Start, condi1_rep4_End)

    #condition 2 info
    ReadXData(xdata2_1, condi2_rep1_Start, condi2_rep1_End)
    ReadXData(xdata2_2, condi2_rep2_Start, condi2_rep2_End)
    ReadXData(xdata2_3, condi2_rep3_Start, condi2_rep3_End)
    ReadXData(xdata2_4, condi2_rep4_Start, condi2_rep4_End)
    ...
    for row in reader:
        try:      
            ...
            ReadYData(condition[1][1]['ydata'], condition[1][1]['Start'], condition[1][1]['End'])
            ReadYData(ydata1_2, condi1_rep2_Start, condi1_rep2_End)
            ReadYData(ydata1_3, condi1_rep3_Start, condi1_rep3_End)
            ReadYData(ydata1_4, condi1_rep4_Start, condi1_rep4_End)
            ...
            ReadYData(ydata2_1, condi2_rep1_Start, condi2_rep1_End)
            ReadYData(ydata2_2, condi2_rep2_Start, condi2_rep2_End)
            ReadYData(ydata2_3, condi2_rep3_Start, condi2_rep3_End)
            ReadYData(ydata2_4, condi2_rep4_Start, condi2_rep4_End)
        except:
            pass
        ...
        try: # if statment, when it is not error   
            ...
            # normalizing condition1 dataset
            NormalizeData(condition[1][1]['xdata'], condition[1][1]['ydata'], normalized_xdata1_1, normalized_ydata1_1, tempRow)
            NormalizeData(xdata1_2, ydata1_2, normalized_xdata1_2, normalized_ydata1_2, tempRow)
            NormalizeData(xdata1_3, ydata1_3, normalized_xdata1_3, normalized_ydata1_3, tempRow)
            NormalizeData(xdata1_4, ydata1_4, normalized_xdata1_4, normalized_ydata1_4, tempRow)
            
            #normalizing condition2 dataset
            NormalizeData(xdata2_1, ydata2_1, normalized_xdata2_1, normalized_ydata2_1, tempRow)
            NormalizeData(xdata2_2, ydata2_2, normalized_xdata2_2, normalized_ydata2_2, tempRow)
            NormalizeData(xdata2_3, ydata2_3, normalized_xdata2_3, normalized_ydata2_3, tempRow)
            NormalizeData(xdata2_4, ydata2_4, normalized_xdata2_4, normalized_ydata2_4, tempRow)
            ...
            if condition1_plotColor=="1":#choose from blue, orange, purple, brown
                plt.plot(xplot1_1, yplot1_1,color=color1_dataAndFit,ls=':',marker='o',label=condition[1][1]['notebook code'])
            ...
            if condition1_plotColor=="2":#choose from blue, orange, purple, brown
                plt.plot(xplot1_1, yplot1_1,color=color2_dataAndFit,ls=':',marker='o',label=condition[1][1]['notebook code'])
            ...
            if condition1_plotColor=="3":#choose from blue, orange, purple, brown
                plt.plot(xplot1_1, yplot1_1,color=color3_dataAndFit,ls=':',marker='o',label=condition[1][1]['notebook code'])
            ...
            if condition1_plotColor=="4":#choose from blue, orange, purple, brown
                plt.plot(xplot1_1, yplot1_1,color=color4_dataAndFit,ls=':',marker='o',label=condition[1][1]['notebook code'])
